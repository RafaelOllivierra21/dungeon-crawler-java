...
public class GameRunner {
    ...
    public static void main(String[] args) {
        ...
        room2.addLoot(new Sword("Steel Sword",
                "A sharp, gleaming blade", 5));
        ...
        room3.addLoot(new HealthPotion("Large Potion",
                "A full bottle of red elixir", 40));

        Room room4 = new Room("The Throne of Shadows");
        room4.addEnemy(new Boss("Shadow Dragon", 100, 12));
        room4.addLoot(new Sword("Legendary Blade",
                "Pulsing with ancient power", 10));
